...
WHERE a1.SERVICE_LINE = 'MEDICAL';


IF OBJECT_ID('tempdb..#Attribution3') IS NOT NULL DROP TABLE #Attribution3;
SELECT a2.PAT_ID, a2.CITY, a2.STATE,a2.SERVICE_TYPE, a2.SERVICE_LINE, a2.SUB_SERVICE_LINE INTO #Attribution3 FROM #Attribution2 a2 WHERE a2.ROW_NUM_DESC = 1;
