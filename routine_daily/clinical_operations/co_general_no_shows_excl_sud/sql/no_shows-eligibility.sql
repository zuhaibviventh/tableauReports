/*
No Shows for Eligibility Appointment Types only
*/
...
SELECT id.IDENTITY_ID,
       ...
       CASE WHEN LEFT(DATEADD(MINUTE, 0, (CONVERT(TIME(0), pev.APPT_TIME))), 5) LIKE '%:15' THEN
                LEFT(DATEADD(MINUTE, -15, (CONVERT(TIME(0), LEFT(DATEADD(MINUTE, 0, (CONVERT(TIME(0), pev.APPT_TIME))), 5)))), 5)
           WHEN LEFT(DATEADD(MINUTE, 0, (CONVERT(TIME(0), pev.APPT_TIME))), 5) LIKE '%:45' THEN
               LEFT(DATEADD(MINUTE, -15, (CONVERT(TIME(0), LEFT(DATEADD(MINUTE, 0, (CONVERT(TIME(0), pev.APPT_TIME))), 5)))), 5)
           WHEN LEFT(DATEADD(MINUTE, 0, (CONVERT(TIME(0), pev.APPT_TIME))), 5) LIKE '%:40' THEN
               LEFT(DATEADD(MINUTE, -10, (CONVERT(TIME(0), LEFT(DATEADD(MINUTE, 0, (CONVERT(TIME(0), pev.APPT_TIME))), 5)))), 5)
           WHEN LEFT(DATEADD(MINUTE, 0, (CONVERT(TIME(0), pev.APPT_TIME))), 5) LIKE '%:20' THEN
               LEFT(DATEADD(MINUTE, -20, (CONVERT(TIME(0), LEFT(DATEADD(MINUTE, 0, (CONVERT(TIME(0), pev.APPT_TIME))), 5)))), 5)
           WHEN LEFT(DATEADD(MINUTE, 0, (CONVERT(TIME(0), pev.APPT_TIME))), 5) LIKE '%:50' THEN
               LEFT(DATEADD(MINUTE, +10, (CONVERT(TIME(0), LEFT(DATEADD(MINUTE, 0, (CONVERT(TIME(0), pev.APPT_TIME))), 5)))), 5)
           WHEN LEFT(DATEADD(MINUTE, 0, (CONVERT(TIME(0), pev.APPT_TIME))), 5) LIKE '%:10' THEN
               LEFT(DATEADD(MINUTE, -10, (CONVERT(TIME(0), LEFT(DATEADD(MINUTE, 0, (CONVERT(TIME(0), pev.APPT_TIME))), 5)))), 5)
           ELSE LEFT(DATEADD(MINUTE, 0, (CONVERT(TIME(0), pev.APPT_TIME))), 5)
       END AS 'APPT_TIME',
       CASE WHEN pev.APPT_STATUS_C IN ( 4, 5, 7, 13 ) THEN 'NO SHOW' --No Show (if course), Late Cancel, Patient to Late to be Seen, and Left Without Being Seen.
       END AS 'NO SHOW',
