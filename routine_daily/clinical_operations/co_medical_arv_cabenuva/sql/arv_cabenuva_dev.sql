...
WITH
    ...
    episode_info AS (
        SELECT 
           ...
           ,episode_by_encounter.SERVICE_TYPE
		   ,episode_by_encounter.SERVICE_LINE
		   ,episode_by_encounter.SUB_SERVICE_LINE
	...
	SELECT 
		...
		,episode_info.STATE
		,episode_info.CITY
		,episode_info.SERVICE_TYPE
		,episode_info.SERVICE_LINE
		,episode_info.SUB_SERVICE_LINE
