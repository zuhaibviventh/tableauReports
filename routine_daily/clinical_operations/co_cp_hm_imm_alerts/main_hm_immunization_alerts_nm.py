...
sql_file = f"{directory}/co_cp_hm_imm_alerts/sql/hm_immunization_alerts_nm.sql"
...
def tableau_push(df, hyper_file):
    ...
    table_definition = TableDefinition(
        ...
        columns=[
            ...
            TableDefinition.Column("HM_IMM_DUE_DATE", SqlType.date()),
    ...
    hm_imm_alerts_logger.info(
        "Clinical Operations - HM Immunization Alerts pushed to Tableau."
    )
