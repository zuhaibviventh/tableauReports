...
SELECT #visits_and_prov.MRN,
       ...
       #visits_and_prov.STATE,
       #visits_and_prov.CITY,
       #visits_and_prov.SERVICE_TYPE,
       #visits_and_prov.SERVICE_LINE,
       #visits_and_prov.SUB_SERVICE_LINE,
...
SELECT #cleanup.MRN,
       ...
       #cleanup.STATE,
       #cleanup.CITY,
       #cleanup.SERVICE_TYPE,
       #cleanup.SERVICE_LINE,
       #cleanup.SUB_SERVICE_LINE,
       #cleanup.TODAY,
       #cleanup.CURRENT_PCP,
       #cleanup.PRC_NAME
FROM #cleanup
