...
WHERE pev.CONTACT_DATE BETWEEN '10/1/2023' AND '9/30/2024'
...
WHERE perv.CONTACT_DATE BETWEEN '10/1/2023' AND '9/30/2024'
      AND pev.APPT_STATUS_C IN ( 2, 6 )
...
INTO #Intake_Minus30
FROM #Last_Intake i
WHERE i.LAST_INTAKE_VISIT_DATE <= (DATEADD(DAY, -43, '9/30/2024'));
