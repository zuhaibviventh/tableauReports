...
remaning = { 'cq_bh_phq9_q10':'main_phq9_q10','cq_bh_mdd_cssrs':'main_mdd_cssrs',
                          'cq_medical_crc_screening':'main_crc_screening','cq_medical_retention_in_care':'main_retention_in_care',
                          'cq_medical_diabetes_a1c':'main_diabetes_a1c', 'cq_bh_active_psych_retention':'main_active_psych_retention', 
                                      'cq_bh_depression_measure_5': 'main_depression_measure_5'}
...
def main():
    ...
    #main_phq9_q10.run(quality_shared_drive)
    ...
    #main_sud_pats_remission.run(quality_shared_drive)
    #main_aoda_measure.run(quality_shared_drive)
    #social_services_adjudicator.run(pe_shared_drive)
    #main_visits_pats.run(operations_shared_drive)
    #main_phq9_q10.run(quality_shared_drive)
    main_vls_qiwp2026.run(quality_shared_drive)
