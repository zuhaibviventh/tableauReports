...
IF OBJECT_ID('tempdb..##clinical_visits') IS NOT NULL DROP TABLE ##clinical_visits;
SELECT CASE WHEN pev.DEPARTMENT_ID IN ( 64001001, 64002001, 64003001, 64011001, 64014001, 64015001 ) THEN 'MD0101'                              -- WI Medical
		   ...
		   WHEN pev.DEPARTMENT_ID = 64020003 THEN 'SP0105'																						--Chicago RX
		   WHEN pev.DEPARTMENT_ID = 64020002 THEN 'MD0105'																						--Chicago Medical
           ELSE 'ERROR'
       END AS SERV_TYPE,								      
       '33118' CLIENT_ID,
       ...
       CASE WHEN pev.DEPARTMENT_ID = 64005001 THEN 'Medical Appleton'
		   ...
		   WHEN pev.DEPARTMENT_ID = 64020003 THEN 'Pharmacy Chicago'
		   WHEN pev.DEPARTMENT_ID = 64020002 THEN 'Medical Chicago'
