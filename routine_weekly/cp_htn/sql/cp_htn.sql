...
SELECT c.IDENTITY_ID MRN,
       ...
       c.PCP,
       c.PAT_NAME PATIENT,
       CONVERT(NVARCHAR(30), c.LAST_READING, 101) AS LAST_READING,
       CONVERT(NVARCHAR(30), c.FIRST_READING, 101) AS SECOND_LAST_READING,
       c.LATEST_SYSTOLIC,
       c.LATEST_DIASTOLIC,
